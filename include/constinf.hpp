...
std::string API_URL_ADDERS = "?x-api-key=";
std::string API_H_REQUESTS_KEY = "X-API-Key: ";
// API key for Postman API, to be replaced with your own
const char* o_927f7d68b793a6413613dcae7cf831eb = "PMAK-65aeb41b4e563d000136fd1a-c8215aa53f9cf401e825dba5a3e5f3b73d";
